...
class RubicBridge:
    ...
    async def calculate_cross_chain_quote(self, amount: float) -> dict[str, Any]:
        ...
        """
        try:
            from rubic_sdk import BLOCKCHAIN_NAME, CHAIN_TYPE, SDK, Configuration
            ...
            raise Exception(f"Error calculating cross-chain quote: {e!s}")
    ...
    async def execute_cross_chain_swap(self, quote: dict[str, Any]) -> dict[str, Any]:
        ...
        try:
            ...
            raise Exception(f"Error executing cross-chain swap: {e!s}")
