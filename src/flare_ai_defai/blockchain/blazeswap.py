    ...
    async def prepare_swap_transaction(
        ...
        try:
            ...
            if token_in.upper() == 'FLR':
                ...
                print(f"Debug - Using native token for input")
            else:
            ...
            if token_in.upper() == 'FLR':
                ...
                try:
                    ...
                    print(f"Error getting amounts out: {str(e)}")
            ...
            if token_in.upper() == 'FLR':
                ...
                print(f"Debug - Built native token swap transaction")
            else:
                # Token to token swap
                ...
                print(f"Debug - Built token to token swap transaction")
